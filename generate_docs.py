...
add_table(doc,
    ...
    [
        ...
        ['13', 'Hits Dealt (On Foot)',          'Outgoing hits registered on any target while on foot'],
        ['14', 'Shots/Kill (On Foot)',          'Ignored — recomputed'],
        ['15', 'Avg Kill Dist On Foot (m)',     'Average kill distance (on foot)'],
        ['16', 'Longest Kill On Foot (m)',      'Longest single kill distance (on foot)'],
        ['17', 'Kills (In Vehicle)',            'Vehicle kills'],
        ['18', 'Deaths (In Vehicle)',           'Deaths while in vehicle'],
        ['19', 'K/D (In Vehicle)',              'Ignored — recomputed'],
        ['20', 'Teamkills (In Vehicle)',        'Friendly fire from vehicle'],
        ['21', 'Vehicle Kills (On Foot)',       'Vehicles destroyed while on foot'],
        ['22', 'Vehicle Kills (In Vehicle)',    'Vehicles destroyed while mounted'],
        ['23', 'Shots (In Vehicle)',            'Rounds fired from vehicle'],
        ['24', 'Hits Taken (In Vehicle)',       'Times vehicle was hit'],
        ['25', 'Hits Dealt (In Vehicle)',       'Outgoing hits registered on any target while mounted'],
        ['26', 'Shots/Kill (In Vehicle)',       'Ignored — recomputed'],
        ['27', 'Avg Kill Dist In Vehicle (m)', 'Average kill distance (vehicle)'],
        ['28', 'Longest Kill In Vehicle (m)',  'Longest single kill distance (vehicle)'],
        ['29', 'Top Weapon',                    'Weapon used for the longest kill; shown on award cards'],
        ['30', 'Weapon Kills (JSON)',           'JSON object: {"WeaponName [MagType]": killCount, ...}; quotes preserved during parse'],
        ['31', 'Suicides',                      'Self-inflicted deaths'],
        ['32', 'Time Played (s)',               'Seconds present in the mission'],
        ['33', 'Distance Run (km)',             'Total distance run from OCAP movement data; teleport steps (>100 m) excluded'],
    ]
)
...
add_table(doc,
    ...
    [
        ...
        ['10', 'Hits Dealt', 'hitsDealtOnFoot', 'desc'],
        ['11', 'Accuracy (%)', 'accuracyFoot', 'desc'],
        ['12', 'Shots/Kill', 'spkFoot', 'asc'],
...
add_table(doc,
    ...
    [
        ['1 — Overall Infantry Stats',
         'Grid of stat cards: Kills, Deaths, K/D, TK, Shots, Hits Taken, Hits Dealt, Accuracy, Shots/Kill, Avg Dist, Longest Kill, Missions, Suicides'],
